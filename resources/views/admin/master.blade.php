...
<head>
    ...
    <link href="{{url('public/admin/css/bootstrap-fileupload.min.css')}}" rel="stylesheet">
...
<body>
    ...
    <script src="{{url('public/admin/js/bootbox.min.js')}}"></script>
    <script src="{{url('public/admin/js/boostrap-fileupload.js')}}"></script>
