       ...
       <!-- Left Image-->
        <div class="span5">
          <ul class="thumbnails mainimage">
            <li class="span5">
              <a  rel="position: 'inside' , showTitle: false, adjustX:-4, adjustY:-4" class="thumbnail cloud-zoom" href="http://localhost/shop/public/uploads/details/product2big.jpg">
                <img src="http://localhost/shop/public/uploads/details/product2big.jpg" alt="" title="">
              </a>
            </li>
            <li class="span5">
          ...
          <ul class="thumbnails mainimage">
            <li class="producthtumb">
              <a class="thumbnail" >
                <img  src="http://localhost/shop/public/uploads/details/product2.jpg" alt="" title="">
              </a>
            </li>
            <li class="producthtumb">
              <a class="thumbnail" >
        ...
        <div class="span7">
          <div class="row">
            <div class="span7">
              ...
              {{$product_detail->name}}</span></h1>
              <div class="productprice">
                <div class="productpageprice">
                  <span class="spiral"></span>{{Helper::product_price($product_detail->price)}}</div>
              </div>
